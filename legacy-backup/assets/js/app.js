...
function inicializarComponentes() {
    ...
    try {
        console.log('  7.2 Inicializando gráficos responsivos...');
        if (typeof inicializarGraficosResponsivos === 'function') {
            inicializarGraficosResponsivos();
        }
    } catch (error) {
        console.error('❌ Error inicializando gráficos responsivos:', error);
    }
    
    try {
        console.log('  7.3 Inicializando modal de edición...');
        inicializarModalEdicion();
    } catch (error) {
