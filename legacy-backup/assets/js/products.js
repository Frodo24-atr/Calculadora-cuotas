        ...
        <div class="producto-item" id="producto-${producto.id}">
            <div class="producto-header">
                ...
                <div class="producto-acciones">
                    ...
                    <button onclick="eliminarProductoDirecto(${producto.id})" class="btn btn-delete" style="background: #f44336; padding: 5px 10px; font-size: 12px;" title="Eliminar producto">🗑️ Eliminar</button>
                </div>
            </div>
